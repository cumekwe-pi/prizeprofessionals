...
<div class="container mb-5 py-md-5">
        <div class="row">
                <div class="col-md-12" id="become_partner">
                        ...
                        <p>     Talk to us! About what you need, how it all works, or just to get to know us better.
                                Give us a call or send us an email below; we aim to respond in a day or so.
                        </p>
                        <div class="col-md-12">
                        ...
                        <form action="{{URL::route('postPartnerForm')}}" method="post" class="col-md-6">
